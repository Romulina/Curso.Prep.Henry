...
function agregarStringInvertida() {
  ...
  String.prototype.reverse = function() { //recibe una frase, la aloja en un array y la devuelve alreves?
...
// ---------------------------------------------------------------------------//
  ...
  class Persona {
    ...
    detalle(){ //método llamado "detalle" que nos devuelve un objeto con las propiedades de la persona
      return {
        Nombre: this.nombre,
